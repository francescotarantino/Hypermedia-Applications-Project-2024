...
import BarChart from '@/components/BarChart.vue'; // Adjust the path as per your project structure
...
const selectedTab = ref<string>('Chapter 1');
  const tabs = [
  { label: 'Roots', id: 'Chapter 1' },
  { label: 'Founding Years', id: 'Chapter 2' },
  { label: 'Expanding Services', id: 'Chapter 3' },
  { label: 'Community', id: 'Chapter 4' },
  { label: 'Challenges', id: 'Chapter 5' },
  { label: 'Innovations', id: 'Chapter 6' },
  { label: 'Pandemic', id: 'Chapter 7' },
  { label: 'Hope&Empowerment', id: 'Chapter 8' },
  { label: 'Future Goals', id: 'Chapter 9' },  
  { label: 'Legacy', id: 'Chapter 10' },
];
</script>
        ...
        <div class="flex flex-row gap-8">
          ...
          <div class="flex flex-col gap-4">
            <div
                ...
                class="flex flex-row items-center w-48 text-lg text-bold text-left p-1 rounded-xl cursor-pointer hover:bg-cream transition ease-in-out duration-200"
          ...
          <!-- Chapter 1 -->
            <div v-if="selectedTab === 'Chapter 1'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 1 - The Vision Takes Root</h2>
          ...
          <transition name="fade">
          <!-- Chapter 2 -->
            <div v-if="selectedTab === 'Chapter 2'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 2 - The Founding Years</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 3 -->
            <div v-if="selectedTab === 'Chapter 3'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 3 - Expanding Services and Outreach</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 4 -->
            <div v-if="selectedTab === 'Chapter 4'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 4 - Building a Strong Community Presence</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 5 -->
            <div v-if="selectedTab === 'Chapter 5'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 5 - Facing Challenges and Overcoming Obstacles</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 6 -->
            <div v-if="selectedTab === 'Chapter 6'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 6 - Innovating for the Future</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 7 -->
            <div v-if="selectedTab === 'Chapter 7'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 7 - The COVID-19 Pandemic and Its Impact</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 8 -->
            <div v-if="selectedTab === 'Chapter 8'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 8 - A Beacon of Hope and Empowerment</h2>
                <p class="text-lg  mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 9 -->
            <div v-if="selectedTab === 'Chapter 9'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 9 - Community Engagement and Future Goals</h2>
                <p class="text-lg mb-8 text-justify">
          ...
          <transition name="fade">
          <!-- Chapter 10 -->
            <div v-if="selectedTab === 'Chapter 10'">
              <h2 class="text-2xl text-center text-orange font-bold mt-8 mb-4">Chapter 10 - The Legacy of Empowerment</h2>
                <p class="text-lg  mb-8 text-justify">
