  ...
  <section>
    <div class="container mx-auto px-8 md:w-3/4">
      ...
      <p class="text-justify text-lg text-gray-600 mt-8 mb-12">
        ...
        to address specific aspects of recovery and empowerment. <br>
        Explore our transformative projects and learn how the SHE Centre is creating pathways to healing and empowerment. Whether you are interested in supporting children
        affected by violence, gaining financial literacy, or exploring the healing power of art, our projects offer
        opportunities for growth, healing, and a brighter future. Join us in building a community where every woman and
        child can thrive free from violence.
      </p>
